    ...
    public class MessageBox : CompositeControl {
        ...
        private void SetControlProperties() {
            ...
            if (!string.IsNullOrEmpty(OKButtonImageUrl)) {
                ...
                //USE DEFAULT
                string imgBtnOkUrl = Page.ClientScript.GetWebResourceUrl(this.GetType(), "ProudMonkey.Common.Controls.css.images.btnSmOK.png");
        ...
        protected override void OnLoad(EventArgs e) {
            ...
            string imgPathWarning = Page.ClientScript.GetWebResourceUrl(this.GetType(), "ProudMonkey.Common.Controls.css.images.imgWarning.png");
            string imgPathError = Page.ClientScript.GetWebResourceUrl(this.GetType(), "ProudMonkey.Common.Controls.css.images.imgError.png");
            string imgPathInfo = Page.ClientScript.GetWebResourceUrl(this.GetType(), "ProudMonkey.Common.Controls.css.images.imgWarning.png");
            string imgPathSuccess = Page.ClientScript.GetWebResourceUrl(this.GetType(), "ProudMonkey.Common.Controls.css.images.imgSuccess.png");
        ...
        public void ShowError(string message, int height, int width) {
            _imageUrl = this.Page.ClientScript.GetWebResourceUrl(typeof(MessageBox), "ProudMonkey.Common.Controls.css.images.imgError.png");
        ...
        public void ShowInfo(string message, int height, int width) {
            _imageUrl = this.Page.ClientScript.GetWebResourceUrl(typeof(MessageBox), "ProudMonkey.Common.Controls.css.images.imgInformation.png");
        ...
        public void ShowSuccess(string message, int height, int width) {
            _imageUrl = this.Page.ClientScript.GetWebResourceUrl(typeof(MessageBox), "ProudMonkey.Common.Controls.css.images.imgSuccess.png");
        ...
        public void ShowWarning(string message, int height, int width) {
            _imageUrl = this.Page.ClientScript.GetWebResourceUrl(typeof(MessageBox), "ProudMonkey.Common.Controls.css.images.imgWarning.png");
