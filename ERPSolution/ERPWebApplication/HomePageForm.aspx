            ...
            <section class="content-wrapper main-content clear-fix">
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <li>
                            <asp:Label ID="Label5" runat="server" AssociatedControlID="UserName">User name</asp:Label>
                        ...
                        <li>
                            ...
                            <asp:TextBox runat="server" ID="TextBox2" TextMode="Password" />
                                    ...
                                    <tr>
                                        <td style="padding-left:40px"><asp:Button ID="Button1" runat="server" Text="Log in" Width="100px" /></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
