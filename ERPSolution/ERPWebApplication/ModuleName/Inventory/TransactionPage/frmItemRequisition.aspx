...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div id="wrapper" style="margin: 0 auto;">
        <asp:UpdatePanel ID="uppnl1" runat="server">
            ...
            <ContentTemplate>
                <table id="tblmas" style="margin-top:0px" runat="server">
                    ...
                    <tr >
                        ...
                        <td  >
                            <table  id="tblsearch" runat="server" style="width:100%; margin-top:0px" >
                                ...
                                <tr>
                                    <td>
                                        <hr id="searchbottom" runat="server" style="border-style: none; border-color: inherit; border-width: 0; background-position: 0% 0%; height: 1px; background-image: linear-gradient(to right, #ccc, #333, #ccc); width: 1050px; background-color: #333; background-repeat: repeat; background-attachment: scroll;" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style =" width: 1050px;">
                                            ...
                                            <hr id="advsearchbottom" runat="server" style="border:0; height: 1px; background: #333;  background-image: linear-gradient(to right, #ccc, #333, #ccc); width: 1050px;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style=" width: 1050px;">
                                ...
                                <tr>
                                    <td style=" width: 100%;">
                                        <hr id="headertop" runat="server" style="border:0; height: 1px; background: #333;  background-image: linear-gradient(to right, #ccc, #333, #ccc); width: 1050px;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style=" width: 100%;">
                                    ...
                                    <table id="tblitemdetautho" runat="server" style="width: 100%; margin-top:0px">
                                        <tr id="trtest" runat="server">
                                            ...
                                            <td style="width: 310px">
                                                <asp:DropDownList ID="ddlForwardTo" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <table style="width:100%; margin-top:0px">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 284px">
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="autoComplete1" runat="server" BehaviorID="AutoCompleteEx2" CompletionInterval="1000" CompletionListCssClass="autocomplete_completionListElement" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="20" DelimiterCharacters="," EnableCaching="false" MinimumPrefixLength="1" ServiceMethod="GetItemList" ServicePath="~/WebService/ServiceSystem.asmx" ShowOnlyCurrentWordInCompletionListItem="true" TargetControlID="txtItem">
                                                    </ajaxToolkit:AutoCompleteExtender>
                                                </td>
                                                <td>&nbsp;</td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtSpec" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 115px">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtBrand" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 115px">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtOrigin" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 115px">&nbsp;</td>
