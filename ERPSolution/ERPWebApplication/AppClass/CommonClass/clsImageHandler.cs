...
/// <summary>
/// Summary description for clsImageHandler
/// </summary>
public class clsImageHandler
{
    public string pCompanyLogo { get; set; }

	public clsImageHandler()
	{
		//
    ...
    private Bitmap GetResizedImage(Bitmap source, int width, int height)
    {
